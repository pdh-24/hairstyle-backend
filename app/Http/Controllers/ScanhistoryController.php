<?php
  ...
  class ScanhistoryController extends Controller {
    ...
    public function getScanhistoryByUserId(Request $request) {
      ...
      try {
        $ScanhistoryList = DB::table("scan_history")->select("	id","scan_date","recom_id")->where('user_id', $validated['id'])->get();
      } catch (\Throwable $th) {
        //throw $th;
